...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/AINative-Studio/versions/refs/heads/main" # AINative Studio

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/AINative-Studio/AINativeStudio-IDE/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/AINative-Studio/AINativeStudio-IDE/releases" # AINative Studio
fi
